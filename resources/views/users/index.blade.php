...
<!-- Modal -->
                            <div class="modal fade" id="viewUser{{ $user->uuid }}" data-bs-backdrop="static"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        ...
                                                        <div class="user-block">
                                                            <h3>General info</h3><span class='text'>
                                                                ...
                                                                <div class='element'><span class='text'>Is disabled
                                                                    </span> : {{ $user->disabled == false ? 'No' : 'Yes' }}</div>
                                ...
                                <button type="button" class="button"><a
                                    href="{{ route('users.ban', $user->uuid) }}">{{ $user->disabled == false ? 'Disable' : 'Unban' }}</a>
                                </button>
                                </td>
                            </tr>
                        @endforeach
